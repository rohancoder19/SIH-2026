    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#CBD5E1] pb-4">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={fetchData}
            className="p-2 bg-[#F8FAFC] hover:bg-[#E2E8F0] border border-[#CBD5E1] rounded-xl text-[#334155] transition shadow-xs cursor-pointer"
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-[#4F46E5] hover:bg-[#4338CA] text-white font-bold text-xs tracking-wide shadow-xs transition flex items-center gap-2 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        <motion.div whileHover={{ y: -2 }} className="p-4 rounded-2xl bg-[#F8FAFC] border border-[#CBD5E1] shadow-xs hover:border-[#94A3B8] transition">
        ...
        <motion.div whileHover={{ y: -2 }} className="p-4 rounded-2xl bg-rose-100/50 border border-rose-300 shadow-xs hover:border-rose-400 transition">
        ...
        <motion.div whileHover={{ y: -2 }} className="p-4 rounded-2xl bg-rose-100/70 border border-rose-400 shadow-xs hover:border-rose-500 transition">
        ...
        <motion.div whileHover={{ y: -2 }} className="p-4 rounded-2xl bg-emerald-100/50 border border-emerald-300 shadow-xs hover:border-emerald-400 transition">
        ...
        <motion.div whileHover={{ y: -2 }} className="p-4 rounded-2xl bg-amber-100/50 border border-amber-300 shadow-xs hover:border-amber-400 transition">
      ...
      <div className="bg-[#F8FAFC] border border-[#CBD5E1] rounded-2xl p-6 shadow-xs">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-3.5 py-1.5 bg-[#E2E8F0] hover:bg-[#CBD5E1] border border-[#CBD5E1] text-xs font-bold text-[#4F46E5] rounded-xl transition cursor-pointer"
          >
                ...
                <tr key={hab.id} className="hover:bg-[#E2E8F0]/40 transition group">
                  ...
                  <td className="py-3 px-3 text-right space-x-2">
                    <button
                      ...
                      className="px-2.5 py-1 bg-[#E2E8F0] hover:bg-[#CBD5E1] border border-[#CBD5E1] text-[#334155] font-semibold rounded-lg transition cursor-pointer"
                    >
                      Detail
                    </button>
                    <button
                      onClick={() => navigate(`/relocation?habitation_id=${hab.id}`)}
                      className="px-2.5 py-1 bg-[#4F46E5] hover:bg-[#4338CA] text-white font-bold rounded-lg transition shadow-xs cursor-pointer"
                    >
                      Recommend Sites
                    </button>
                  </td>
